          ...
          <div id="id3" style="height: 331px; left: 411px; position: absolute; top: 83px; width: 284px; z-index: 1; " class="style_SkipStroke_2 shape-with-text">
            <div class="text-content style_External_284_331" style="padding: 0px; ">
              <div class="style_2">
                ...
                <p style="padding-top: 0px; " class="Sidebar_Body"><span class="Bold">name</span>Ê<?php echo $row['movie_name']?><br /></p>
                <p style="padding-top: 4px; " class="Sidebar_Body"><span class="Bold">year</span>Ê <?php echo $row['year']?></p>
                <p style="padding-top: 4px; " class="Sidebar_Body"><span class="Bold">Date of Release</span>Ê <?php echo $row['date_of_release']?><br /></p>
             <p style="padding-bottom: 0pt; padding-top: 4px; " class="Sidebar_Body"><span class="Bold">Crew</span>Ê </p> <br/>                
...
<input type="submit" value="Send" onclick="this.review.submit();"/>
          ...
          <div style="height: 480px; line-height: 480px; " class="spacer">Ê</div>
        </div>
